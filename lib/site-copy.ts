...
const es = {
  ...
  pricing: {
    ...
    founderPerks: [
      "Plan Pro al precio del Base: 89 €/mes, fijo de por vida",
  ...
  trust: {
    ...
    noTracking: "Sin cookies de rastreo",
  },
  quick: {
    eyebrow: "Contacto rápido",
    title: "¿Solo una pregunta? Sin demo, sin compromiso.",
    sub: "Escríbenos lo que quieras y te respondemos en 48 h, sin comercial de por medio.",
    name: "Tu nombre",
    namePh: "p. ej. Marta",
    email: "Tu email",
    emailPh: "tu@restaurante.com",
    message: "Mensaje",
    messagePh: "¿Qué quieres saber?",
    send: "Enviar mensaje",
    sending: "Enviando…",
    doneTitle: "Recibido.",
    doneBody: "Te respondemos en 48 h a tu correo.",
    errName: "Escribe tu nombre.",
    errEmail: "Escribe un email válido.",
    errMessage: "Escribe tu mensaje.",
    errGeneric: "No hemos podido enviar tu mensaje. Inténtalo de nuevo o escríbenos a hola@restoraapp.com.",
    privacyPre: "Al enviar aceptas nuestra",
    privacyLink: "política de privacidad",
  },
  newsletter: {
    eyebrow: "Recurso gratuito",
    title: "Una checklist de food cost para revisar tu margen cada semana.",
    sub: "Doce comprobaciones sobre compras, escandallos, mermas e inventario, en un PDF de una página listo para imprimir y colgar en el pase.",
    bullets: ["Compras y proveedores", "Escandallos y mermas", "Inventario y consumo"],
    emailPh: "tu@restaurante.com",
    cta: "Quiero la checklist",
    sending: "Enviando…",
    consent: "Acepto recibir la checklist y, de vez en cuando, novedades de RESTORA. Sin spam; te das de baja cuando quieras.",
    doneTitle: "Aquí tienes tu checklist.",
    doneBody: "Descárgala ahora. Te avisaremos también de las novedades de RESTORA.",
    download: "Descargar la checklist (PDF)",
    errEmail: "Escribe un email válido.",
    errConsent: "Marca la casilla para continuar.",
    errGeneric: "No hemos podido registrar tu email. Inténtalo de nuevo.",
  },
  share: {
    label: "Compartir",
  ...
  video: {
    ...
    title: "Así se ve RESTORA en una cocina real.",
    sub: "Qué ves cada mañana, cómo entra una compra y cómo el escandallo avisa antes de que pierdas margen.",
    play: "Ver el vídeo",
    soon: "Próximamente",
    soonNote: "Mientras tanto, te lo enseñamos en directo en una demo de 30 minutos con un plato tuyo.",
    cta: "Pedir la demo",
  },
  footer: {
...
const ca: SiteCopy = {
  ...
  pricing: {
    ...
    founderPerks: [
      "Pla Pro al preu del Base: 89 €/mes, fix de per vida",
  ...
  lead: {
    ...
    privacyPre: "En enviar acceptes la nostra",
  ...
  quick: {
    eyebrow: "Contacte ràpid",
    title: "Només una pregunta? Sense demo, sense compromís.",
    sub: "Escriu-nos el que vulguis i et responem en 48 h, sense comercial pel mig.",
    name: "El teu nom",
    namePh: "p. ex. Marta",
    email: "El teu email",
    emailPh: "tu@restaurant.com",
    message: "Missatge",
    messagePh: "Què vols saber?",
    send: "Enviar missatge",
    sending: "Enviant…",
    doneTitle: "Rebut.",
    doneBody: "Et responem en 48 h al teu correu.",
    errName: "Escriu el teu nom.",
    errEmail: "Escriu un email vàlid.",
    errMessage: "Escriu el teu missatge.",
    errGeneric: "No hem pogut enviar el teu missatge. Torna-ho a provar o escriu-nos a hola@restoraapp.com.",
    privacyPre: "En enviar acceptes la nostra",
    privacyLink: "política de privacitat",
  },
  newsletter: {
    eyebrow: "Recurs gratuït",
    title: "Una checklist de food cost per revisar el teu marge cada setmana.",
    sub: "Dotze comprovacions sobre compres, escandalls, minves i inventari, en un PDF d'una pàgina a punt per imprimir i penjar al pas.",
    bullets: ["Compres i proveïdors", "Escandalls i minves", "Inventari i consum"],
    emailPh: "tu@restaurant.com",
    cta: "Vull la checklist",
    sending: "Enviant…",
    consent: "Accepto rebre la checklist i, de tant en tant, novetats de RESTORA. Sense spam; et dones de baixa quan vulguis.",
    doneTitle: "Aquí tens la teva checklist.",
    doneBody: "Descarrega-la ara. També t'avisarem de les novetats de RESTORA.",
    download: "Descarregar la checklist (PDF)",
    errEmail: "Escriu un email vàlid.",
    errConsent: "Marca la casella per continuar.",
    errGeneric: "No hem pogut registrar el teu email. Torna-ho a provar.",
  },
  share: {
    label: "Compartir",
    whatsapp: "Compartir per WhatsApp",
  ...
  video: {
    eyebrow: "Vídeo de presentació",
    title: "Així es veu RESTORA en una cuina real.",
    sub: "Què veus cada matí, com entra una compra i com l'escandall avisa abans que perdis marge.",
    play: "Veure el vídeo",
    soon: "Properament",
    soonNote: "Mentrestant, t'ho ensenyem en directe en una demo de 30 minuts amb un plat teu.",
    cta: "Demanar la demo",
  },
  footer: {
