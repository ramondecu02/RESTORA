  ...
  return (
    <>
      ...
      <Confirm open={open} onClose={() => setOpen(false)} title={`¿Borrar este ${label}?`} danger confirm="Borrar" busy={pending}
        text="Se deshace todo lo que movió: el stock (lo que hayas recontado después se respeta), el precio medio y el último precio de cada artículo, las subidas de precio detectadas, los nombres e IVA que aprendió y el coste de tus platos."
